...
artifact_manifest = Table(
    ...
    Column("prediction_family_id", String, nullable=False),
    Column("prediction", JSON, nullable=False),
    Column("training_metric_descriptors", JSON, nullable=False),
    Column("chain_name", String, nullable=False),
    Column("dataset_id", String, nullable=False),
    Column("dataset_name", String, nullable=False),
    Column("problem_id", String, nullable=False),
...
simulation_summary = Table(
    ...
    Column("prediction_id", String, nullable=False),
    Column("prediction_family_id", String, nullable=False),
    Column("simulation_metric_descriptors", JSON, nullable=False),
    Column("chain_name", String, nullable=False),
    Column("dataset_id", String, nullable=False),
    Column("dataset_name", String, nullable=False),
    Column("variant", String, nullable=False),
    ...
    Column("window_metrics", JSON, nullable=False),
