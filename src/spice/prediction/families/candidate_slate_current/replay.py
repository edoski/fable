"""Current-family decode and replay helpers."""
...
from ...base import MetricSet, PredictionSimulationRun, PredictionSimulationSummary
from .batch import CandidateSlateTargetBatch
from .metrics import summarize_window_metric
...
def run_replay(
    ...
    summary = PredictionSimulationSummary(
        ...
        window_metrics={
            "profit_over_baseline": summarize_window_metric(
                [run.metrics["profit_over_baseline"] for run in runs]
            ),
            "cost_over_optimum": summarize_window_metric(
                [run.metrics["cost_over_optimum"] for run in runs]
            ),
            "baseline_cost_over_optimum": summarize_window_metric(
